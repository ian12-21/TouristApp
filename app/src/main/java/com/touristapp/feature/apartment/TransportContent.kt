    ...
    Column(
        ...
        if (transportationServices.isNotEmpty()) {
            ...
            LazyRow(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                items(transportationServices, key = { it.id }) { service ->
                    TransportServiceCard(service)
                }
            }
        }
...
@Composable
private fun TransportServiceCard(service: TransportationService) {
    ...
    Surface(
        ...
        Box {
            ...
            AsyncImage(
                model = service.thumbImageUrl.ifBlank { null },
