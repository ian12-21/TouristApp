...
internal fun CheckoutContent(apartment: Apartment, currentStay: Stay?) {
    ...
    Column(
            ...
            Surface(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.apartment_checkout_title),
                    ...
                    if (currentStay?.checkOut != null) {
                        ...
                        Row(
                            ...
                            Column {
                                Text(
                                    text = stringResource(R.string.apartment_checkout_date),
                    ...
                    if (apartment.checkoutTime.isNotBlank()) {
                        Row(
                            ...
                            Column {
                                Text(
                                    text = stringResource(R.string.apartment_checkout_time),
                                    style = MaterialTheme.typography.labelMedium,
                                    color = MaterialTheme.colorScheme.onPrimaryContainer.copy(alpha = 0.7f)
                                )
                                Text(
            ...
            Surface(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(
                            text = stringResource(R.string.apartment_checkout_instructions),
                            style = MaterialTheme.typography.titleMedium,
                            fontWeight = FontWeight.SemiBold,
                            color = MaterialTheme.colorScheme.onSurface
                        )
        ...
        if ((currentStay?.checkOut == null) && apartment.checkoutTime.isBlank() && apartment.checkoutInstructions.isBlank()) {
            Text(
                text = stringResource(R.string.apartment_checkout_empty),
                style = MaterialTheme.typography.bodyLarge,
